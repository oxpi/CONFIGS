...
kmi_props_setattr(kmi.properties, 'name', 'object.thirdpieobject')
...
kmi = km.keymap_items.new('wm.call_menu_pie', 'RIGHTMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'mesh.secondpiemesh')
kmi = km.keymap_items.new('mesh.edge_collapse', 'ACCENT_GRAVE', 'PRESS', alt=True)
kmi = km.keymap_items.new('uv.project_from_view', 'U', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'scale_to_bounds', False)
kmi = km.keymap_items.new('mesh.merge', 'W', 'PRESS', alt=True)
kmi = km.keymap_items.new('mesh.inset', 'I', 'PRESS', alt=True)
kmi = km.keymap_items.new('mesh.loop_multi_select', 'R', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'ring', True)
kmi = km.keymap_items.new('mesh.separate', 'X', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('view3d.ruler', 'P', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.snap_selected_to_grid', 'RIGHTMOUSE', 'PRESS', shift=True)
